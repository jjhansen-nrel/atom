function meanField=spatialMeanRe_t1(S,R,xy,tt,c01,vx01,vy01,Lo,Hi,showFig)
...
c0est=c01*c01/(c01+aver(1));
c02=c0est*c0est;
dc=c02/c01/c01*std_a(1);
dc2=2*c0est*dc;
gamma=1.4;
Ra=287.058;
gR=gamma*Ra;
...
vy0est=aver(3)+vy01;
dvy=std_a(3);
tt0=Li.*(er+d)/c01/c01;% travel times due to the mean fields only
