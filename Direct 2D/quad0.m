function [Q,fcnt] = quad0(funfcn,a,b,tol,trace,varargin)
...
mltp=0;
while ~isfinite(y(1)) & mltp<1000
    mltp=mltp+1;
   y(1) = feval(f,a+mltp*eps*(b-a),varargin{:});
   fcnt = fcnt+1;
end
mltp=0;
while ~isfinite(y(7)) & mltp<1000
    mltp=mltp+1;
   y(7) = feval(f,b-mltp*eps*(b-a),varargin{:});
   fcnt = fcnt+1;
end
